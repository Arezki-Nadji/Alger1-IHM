...
//select d'un tuple d'une table avec condition where
    ...
    public ResultSet count(){
        connexionDatabase();
        SQL = "SELECT COUNT(*) AS pit FROM utilisateur ";
        return this.exécutionQuery(SQL);
        
    }
    public ResultSet Sum(){
        connexionDatabase();
        SQL = "SELECT SUM(Absence) AS pit FROM utilisateur";
        return this.exécutionQuery(SQL);
    }
    public ResultSet SUm(){
         connexionDatabase();
        SQL = "SELECT SUM(Retard) AS pit FROM utilisateur";
        return this.exécutionQuery(SQL);
    }
    

//select avec les nom des colum a select + nom de la table
...
//insert avec les nom des colum et un tableau de valeur
...
//supression avec condition
    ...
    public String queryUpdate(String nomTable , String[] nomColonne, java.sql.Time[] contenuTableau, String état) {
        connexionDatabase();
        int i;
        SQL = "UPDATE " + nomTable + " SET ";
    ...
    public ResultSet selectTime(String nomTable,String état) {
       connexionDatabase();
        SQL = "SELECT * FROM " + nomTable + " WHERE " + état;
        return this.exécutionQuery(SQL);
    }
